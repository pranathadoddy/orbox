...
using Orderbox.Mvc.Areas.Agent.Models.Product;
...
namespace Orderbox.Mvc.Areas.Agent.Controllers
{
    ...
    public class ProductController : BaseController
    {
        ...
        public async Task<ActionResult> PagedSearchGridJson([ModelBinder(typeof(GridModelBinder))] GridModel model)
        {
            ...
            var filters = model.Filters + $" and Type=\"{CoreConstant.ProductType.Product}\"";
        ...
        public async Task<IActionResult> Create(CreateModel model)
        {
            ...
            var dto = new ProductDto
            {
                ...
                Type = CoreConstant.ProductType.Product,
                Name = model.Name,
            ...
            {
                IsSuccess = true,
                RedirectUrl = $"/Agent/Product/Index/{model.TenantId}"
            });
        }
