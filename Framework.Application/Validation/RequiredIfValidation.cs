...
namespace Framework.Application.Validation
{
    ...
    public sealed class RequiredIfValidation : ValidationAttribute
    {
        #region Constructor

        /// <summary>
        ///     Initializes a new instance of the <see cref="RequiredIfValidation" /> class.
        /// </summary>
        /// <param name="otherProperty">The other property.</param>
        /// <param name="otherPropertyValue">The other property value.</param>
        public RequiredIfValidation(string otherProperty, object otherPropertyValue)
        ...
        /// <summary>
        ///     Gets or sets a value indicating whether other property's value should match or differ from provided other
        ///     property's value (default is <c>false</c>).
        /// </summary>
        /// <value>
